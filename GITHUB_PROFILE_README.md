...
My engineering workflow is AI-assisted and human-directed. I define outcomes and constraints, direct coding agents through implementation, inspect changes and test output, diagnose failures, and iterate until the agreed evidence is met.
...
Before focusing on AI systems, I spent more than 12 years in the U.S. military across Navy electrical systems and travel-program administration and Marine Corps metal fabrication. That background shows up in how I build: inspect the system, respect dependencies, document the procedure, preserve rollback, and verify the result.

## A note on forks

I use public forks for research and integration work. The projects highlighted above contain original integration, plugin, tooling, or documentation work; each repository includes its own provenance and status notes.
